...
# File upload option
uploaded_file = st.file_uploader("/content/diabetes (3).csv", type=["csv"])
...
# Ensure that the scaler is fitted on the training data (this will be used for user input)
...
# Adding a footer
st.markdown("---")
st.markdown("Built with ❤️ by [HARSH,TRAPTI,CHAHAT,SANJEEVANI].")
